...
void KalmanFilter::handleLidarMeasurement(LidarMeasurement meas, const BeaconMap& map)
{
    if (isInitialised())
    {
        ...
        // The Kalman Filter Update Step for the Lidar Measurements
        ...
        if (meas.id != -1 && map_beacon.id != -1)
        {
            ...
            // The wrapAngle() function on angular values to always keep angle
...
void KalmanFilter::predictionStep(GyroMeasurement gyro, double dt)
{
    if (isInitialised())
    {
        ...
        //-------------The Kalman Filter Prediction Step for the system-------------------

        // The state vector has the form [PX, PY, PSI, V].
        // The Gyroscope measurement as an input into the prediction step.
        // The wrapAngle() function on angular values to always keep angle values within correct range,
        // otherwise strange angle effects might be seen.
